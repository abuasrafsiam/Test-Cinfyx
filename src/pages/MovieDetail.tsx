  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="relative w-full aspect-video overflow-hidden">
        {extras.trailerKey ? (
          <iframe
            src={`https://www.youtube.com/embed/${extras.trailerKey}?autoplay=1&mute=1&loop=1&playlist=${extras.trailerKey}&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&iv_load_policy=3&disablekb=1&fs=0`}
