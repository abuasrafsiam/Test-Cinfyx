...
const emptyAnnouncement = { title: "", message: "", link: "", expires_at: "", active: true };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Create popups and announcements for app users</p>
        </div>
              ...
              <div className="mb-4 p-4 bg-primary/10 border border-primary/20 rounded-xl">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {editing.link && (
                      <a className="text-xs text-primary mt-2 flex items-center gap-1">
